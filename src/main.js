...
const pageContent = {
  ...
  flowers: `<div class="modal-inner flowers-page"><p class="eyebrow">flowers for you</p><h2>For my favorite bloom,<br><em>lilies and all.</em></h2><p>Some love stories are full of little flowers, soft mornings, and the kind of joy that keeps showing up. Graceful, bright, and full of meaning.</p><div class="bouquet-scene" aria-label="Real lily bouquet"><img class="real-lily" src="/lily-transparent.png" alt="Real lily bouquet">${flowerPolaroids}</div><p class="lily-note">for the girl who makes every day feel beautiful.</p><span class="signature">a bouquet that never wilts</span></div>`,
