...
const pageContent = {
  ...
  wrapped: `<div class="modal-inner wrapped-page"><p class="eyebrow">our love wrapped</p><h2>Another year of<br><em>choosing you.</em></h2><div class="stats single-stat"><div class="highlight-stat"><strong>365</strong><span>DAYS OF YOU</span></div></div><p class="big-letter">You made this year softer, brighter, and so much more ours.</p><div class="memory-strip">${pageMemoryBits.wrapped}</div></div>`,
